...
MarkerControls.prototype.updateWithModelViewMatrix = function(modelViewMatrix) {
  ...
  if (this.context.parameters.trackingBackend === "artoolkit") {
    var tmpMatrix = new THREE$1.Matrix4().copy(
  ...
  var markerAxisTransformMatrix = new THREE$1.Matrix4().makeRotationX(
    Math.PI / 2
  );
...
Context.prototype._initArtoolkit = function(onCompleted) {
  ...
  this._artoolkitProjectionAxisTransformMatrix.multiply(
    new THREE$1.Matrix4().makeRotationY(Math.PI)
  );
  this._artoolkitProjectionAxisTransformMatrix.multiply(
    new THREE$1.Matrix4().makeRotationZ(Math.PI)
  );
...
//# sourceMappingURL=THREEXAR.mjs.map
